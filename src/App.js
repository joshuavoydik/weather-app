...
function App() {
  ...
  useEffect(() => {
    const cities = ['Portland', 'Anaconda', 'Charleston', 'Middlebury'];
  ...
  return (
    <div className="App grid grid-cols-2 grid-rows-2 h-screen gap-4 p-4">
      {weatherData.map((data, index) => (
        <div key={index} className="weather rounded-lg bg-blue-600 p-4 text-white shadow-lg min-w-full min-h-full bg-opacity-30 flex flex-col justify-center items-center hover:bg-blue-700 transition-all duration-200">
